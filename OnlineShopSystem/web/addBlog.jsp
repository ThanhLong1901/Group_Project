                                                ...
                                                <div class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <ul class="user-profile-list">
                                                            ...
                                                            <li><span>Blog Title</span><input name="title" type="text" placeholder="Blog Title" style="width: 70%"></input></li>
                                                            <li style="display: flex"><span>Blog Content</span><textarea name="content" type="text" placeholder="Content" style="width: 70%; height: 250px"></textarea></li>
                                                            <li><span>Author Name</span><input name="authorName" type="text" placeholder="Author Name" style="width: 70%"></li>

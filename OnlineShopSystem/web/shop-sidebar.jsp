                                            ...
                                            <c:forEach items="${listCart}" var="ca">
                                                <div class="media">
                                                    <a class="pull-left" href="#!">
                                                        <img class="media-object" src="images/shop/products/${ca.productImg}" alt="image" />
                                                    </a>
                                                    <div class="media-body">
                                                        <h4 class="media-heading"><a href="#!">${ca.productName}</a></h4>
                                                        <div class="cart-price">
                                                            <span>${ca.amount} x</span>
                                                            <!--<span>${ca.productPrice - ca.productPrice*ca.discount}</span>-->
                                                            <span>
                                                                <fmt:formatNumber pattern="###.##" value="${ca.productPrice - ca.productPrice*ca.discount}">
                                                                </fmt:formatNumber>
                                                            </span>
                                                        </div>
                                                        <h5><strong>
                                                                <fmt:formatNumber pattern="###.##" value="${ca.amount*(ca.productPrice - ca.productPrice*ca.discount)}"></fmt:formatNumber>
                                                                </strong></h5>
                                                        </div>

                            ...
                            <div class="col-xl-12 col-lg-7" style="height: 100%">
                                <div class="card shadow mb-4">
                                            ...
                                            <span>
                                                ...
                                                <select name="category">
                                                    ...
                                                    <c:forEach items="${requestScope.listCateBlog}" var="r">
                                                        <%--<option ${r.cateBlogID==requestScope.category? "selected" : "" } value="${r.getCateBlogID()}">${r.getCateBlogName()}</option>--%>
                                    ...
                                    <c:forEach begin="1" end="${numberPage}" var="i">
                                            ...
                                            <a style ="${idPage==i?'color: red':""}; padding-left: 10px; padding-right: 10px"  href="lstpost?id=${i}"  >${i}  </a>

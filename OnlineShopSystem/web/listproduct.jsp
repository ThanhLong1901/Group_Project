                                                        ...
                                                        <tr class="tr_content">
                                                            ...
                                                            <td class="content_Active">
                                                                <c:if test="${l.isActive == true}">
                                                                    <div class="content_Active_Yes">Yes</div>
                                                                </c:if>
                                                                <c:if test="${l.isActive == false}">
                                                                    <div class="content_Active_No">No</div>
                                                                </c:if>     
                                                            </td>
                                                            <td class="content_Edit">
                                                                <div>
                                                                    ...
                                                                    <span>
                                                                        <a onclick="ShowMess(${l.productID})"><i class="fa-solid fa-trash-can"></i></a>
                                                                    </span>
                                                                    <span>
